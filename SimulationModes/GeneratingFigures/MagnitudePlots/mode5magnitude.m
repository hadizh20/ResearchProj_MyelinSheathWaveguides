load C:/Users/Mike/Documents/EF/598projectfiles/test/birefirngent_myelin_long/guidedmode(s)/500/simsForModes/birefringent_modes_magnitudePlots/mode5magnitude.mat;
x =lum.x;
y =lum.y;
A =lum.z;
colormap jet ;
...
exportgraphics(gca, "magnitudeplot_mode_5_B.eps");
