...
load("mode" + index + "\data_sourceM"+ index + "_Efield.mat");
...
colormap jet ;
imagesc(y2,x2, flipud(sqrt(realEx.^2 + realEy.^2 + realEz.^2)) );
caxis([0,1]);
...
exportgraphics(fig0, "magnitudePlot_M" + index + "_standard.eps");
...
exportgraphics(fig3, "vectorplot_combinationM" + index + "_standard.eps");
